...
PROJETO BASE
Projeto utilizado na apresentação para os investidores: Download do projeto
base
DESAFIO
O projeto desenvolvido está sem nenhuma das boas práticas de arquitetura
de software que nós aprendemos durante o curso.
O seu desafio será desenvolver uma aplicação utilizando os conceitos
apresentados, como:
.
...
•Mensageria;
•E outros conceitos abordados.Hackathon
Página 3 de 5
...
•
A nova versão do sistema deve processar mais de um vídeo ao mesmo
tempo.
•Em caso de picos, o sistema não deve perder uma requisição.
•O Sistema deve ser protegido por usuário e senha.
•O fluxo deve ter uma listagem de status dos vídeos de um usuário.
•Em caso de erro, um usuário pode ser notificado (e-mail ou
...
•Banco de Dados: PostgreSQL + Redis (cache) (ou um outro de preferência
do grupo).
•
Monitoramento: Prometheus + Grafana, ELK Stack ou algo de preferência
do grupo.Hackathon
•
Página 4 de 5
